...
java -Djava.util.logging.config.file=logging.properties -Xms64M -Xmx6144M -cp "$OMC/OsmAndMapCreator.jar:$OMC/lib/OsmAnd-core.jar:$OMC/lib/*.jar" net.osmand.MainUtilities merge-index ${CURDIR}/${1}_${region}.road.obf ${CURDIR}/${1}*.obf
